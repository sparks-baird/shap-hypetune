...
import shaphypetune as module

# name of module is shaphypetune, but it's uploaded to PyPI as shap-hypetune
name, version = module.__name__, module.__version__
pypi_name = "shap-hypetune"
os.system(f"grayskull pypi {pypi_name}=={version}")

Path("scratch").mkdir(exist_ok=True)

fpath = join(pypi_name, "meta.yaml")
